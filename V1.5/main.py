#All features in V1.4.2 plus new chat continuing flow.
import ollama
    ...
    if text == "":
        ...
        if is_app_open == 0:
            ...
            with sr.Microphone() as source1:
                ...
                print(format_for_terminal("*Do you want to continue the conversation? Yes or No?*"))
                voice_continue = speak("Do you want to continue the conversation? Yes or No?")
                time.sleep(0.1)
                print(format_for_terminal("*Listening for your response...*"))
            ...
            try:
                ...
                print("-" * columns)
                print(format_for_terminal(f"**You:** {voice_continue_recogniser}"))
                print("-" * columns)
            except sr.UnknownValueError:
                print(format_for_terminal("Could not understand audio"))

            print()
            if voice_continue_recogniser == " ":
                print(format_for_terminal("**No input detected.**"))
                pass
            elif voice_continue_recogniser not in ["yes", "Yes", "Yes!", "yes!", "Yes.", "yes.", "Yes?", "yes?", "yeah", "Yeah", "yeah!", "Yeah!", "yeah.", "Yeah.", "yeah?", "Yeah?", "yep", "Yep", "yep!", "Yep!", "yep.", "Yep.", "yep?", "Yep?", "absolutely", "Absolutely", "absolutely!", "Absolutely!", "absolutely.", "Absolutely.", "absolutely?", "Absolutely?", "YES", "YES!", "YES.", "YES?", "YEAH", "YEAH!", "YEAH.", "YEAH?", "YEP", "YEP!", "YEP.", "YEP?", "ABSOLUTELY", "ABSOLUTELY!", "ABSOLUTELY.", "ABSOLUTELY?"]:
                print("Bye!")
                speak("Bye!")
                break
            else:
