#All features in V1.1 plus the voice agent mode to open applications.
...
while True:
    ...
    if "open" in text.lower().strip(".").strip(",").strip("!").strip("?"):
