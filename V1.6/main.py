# All features in V1.5 plus a basic Terminal User Interface.
import ollama
...
while True:
    ...
    if "open" in text.strip(".").strip(",").strip("!").strip("?").lower():
        ...
        if len(converted_text) > 1:
            ...
            console.print(Text.from_ansi(format_for_terminal(f"**Opening {next_word}**")))
    ...
    if text == "":
        ...
        if is_app_open == 0:
            ...
            if norm == "":
                ...
                console.print(Text.from_ansi(format_for_terminal("Bye, Please Visit Again!")))
